...
namespace Jitter.Tests.Models
{
    ...
    public class JitterRepositoryTests
    {
        ...
        [TestMethod]
        public void JitterReposittoryEnsureICanSearchByName()
        { //be able to search for case insensitive search for first and last name
            var expected = new List<JitterUser>
            {
                ...
                new JitterUser { Handle = "treedancer", FirstName = "Richard", LastName = "Sandlehook"}
        ...
        {
            // created DateTime to order jots
        ...
        public void JitterRepositoryEnsureICanCreateAJot()
        {
            ...
            //have to tell mock to add
            //listen for call that has jot being added to it
